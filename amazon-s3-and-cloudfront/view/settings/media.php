...
?>
<div id="tab-media" data-prefix="as3cf" class="as3cf-tab as3cf-content<?php echo ( $selected_bucket ) ? ' as3cf-has-bucket' : ''; // xss ok ?>">

	<?php if ( empty( $selected_bucket ) && $this->get_aws()->needs_access_keys() ) : ?>

		<div class="as3cf-need-help as3cf-error inline">
			<span class="dashicons dashicons-info"></span>
			<?php printf( __( '<a href="%s">Define your AWS keys</a> to configure WP Offload S3', 'amazon-s3-and-cloudfront' ), '#settings' ) ?>
		</div>

	<?php else: // access keys provided ?>
